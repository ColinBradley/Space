...
namespace SpaceTraders.Model
{
    ...
    public partial class ShipFrame : IEquatable<ShipFrame>, IValidatableObject
    {
        ...
        public ShipFrame(SymbolEnum symbol = default, string? name = default, string? description = default, int condition = default, int moduleSlots = default, int mountingPoints = default, int fuelCapacity = default, ShipRequirements? requirements = default)
        {
            this.Symbol = symbol;
