...
namespace SpaceTraders.Model
{
    ...
    public partial class GetStatus200ResponseStats : IEquatable<GetStatus200ResponseStats>, IValidatableObject
    {
        /// <summary>
        ...
        public GetStatus200ResponseStats(int agents = default, int ships = default, int systems = default, int waypoints = default)
        {
            this.Agents = agents;
            this.Ships = ships;
        ...
        {
            return HashCode.Combine(this.Agents, this.Ships, this.Systems, this.Waypoints);
        }
