...
namespace SpaceTraders.Model
{
    ...
    public partial class Waypoint : IEquatable<Waypoint>, IValidatableObject
    {
        ...
        public Waypoint(string? symbol = default, WaypointType type = default, string? systemSymbol = default, int x = default, int y = default, List<WaypointOrbital>? orbitals = default, WaypointFaction? faction = default, List<WaypointTrait>? traits = default, Chart? chart = default)
        {
