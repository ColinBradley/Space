...
namespace SpaceTraders.Model
{
    ...
    public partial class Faction : IEquatable<Faction>, IValidatableObject
    {
        ...
        public Faction(FactionSymbols symbol = default, string? name = default, string? description = default, string? headquarters = default, List<FactionTrait>? traits = default, bool isRecruiting = default)
        {
            this.Symbol = symbol;
