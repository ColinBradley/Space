...
namespace SpaceTraders.Model
{
    ...
    public partial class MarketTransaction : IEquatable<MarketTransaction>, IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.PricePerUnit < (int)0)
            {
                yield return new ValidationResult("Invalid value for PricePerUnit, must be a value greater than or equal to 0.", new [] { "PricePerUnit" });
            }
