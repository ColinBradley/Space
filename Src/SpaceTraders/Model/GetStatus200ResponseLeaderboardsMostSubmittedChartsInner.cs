...
namespace SpaceTraders.Model
{
    ...
    public partial class GetStatus200ResponseLeaderboardsMostSubmittedChartsInner : IEquatable<GetStatus200ResponseLeaderboardsMostSubmittedChartsInner>, IValidatableObject
    {
        /// <summary>
